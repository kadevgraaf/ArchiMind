...
class OntoWiki_Toolbar
{
    ...
    protected $_defaultButtons = array(
        ...
        self::METADATA   => array('name' => 'Metadata', 'image' => 'edit', 'id' => 'metadatatoggle'),
        ...
        self::USER    => array('name' => 'user', 'image' => 'contextwidget'),
        self::WIKIPAGE_OVERVIEW => array('name' => 'wikipage_overview', 'image' => 'list')
