...
function CheckAuthentication()
{
	...
	//ONTOWIKI_ROOT . 
	/*
	$includePath = '/../application/classes/OntoWiki/Controller';// . PATH_SEPARATOR;
	include($includePath);
	$includePath = '/../application/controllers/IndexController.php';// . PATH_SEPARATOR;
	include($includePath);
	
	$OntoWiki_View = new OntoWiki_View();
	//ApplicationController	
	$authResult = $OntoWiki_View->_owApp->authResult;
	//$this->_owApp->authResult
	echo $authResult;
	
	require_once 'OntoWiki/Plugin.php';

	$app = Erfurt_App::getInstance();
echo 	$app->getAuth()->getIdentity()->isAnonymousUser();
...
*/
# Include Erfurt-APP-Class
//require_once 'App.php';


/*
	$includePath = '/../libraries/Erfurt/App.php';// . PATH_SEPARATOR;
...
$app = Erfurt_App::getInstance( );
	echo 	$app->getAuth()->getIdentity()->isAnonymousUser();
*/
//echo "test"  . isset($_SESSION['authentication']);
	return true;
}
